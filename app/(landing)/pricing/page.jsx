...
export default function PricingPage() {
  return (
    <section className=" z-10 flex flex-col  gap-6 py-8 md:max-w-6xl md:py-12 lg:py-24">
      <div className="mx-auto flex w-full flex-col gap-4 md:max-w-6xl">
        <h2 className="font-display text-5xl leading-[1.1] sm:text-3xl md:text-6xl">
