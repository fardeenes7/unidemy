  ...
  return (
    <div className="">
      <div className="relative ">
        <div className="relative mx-auto max-w-2xl px-4 text-center font-display sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="relative mt-12 flex justify-center sm:mt-16">
          <div className="flex rounded-lg bg-gray-700 p-0.5">
            <button
              type="button"
              className="relative whitespace-nowrap rounded-md border-gray-700 bg-white px-6 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-700"
            >
              Monthly billing
            </button>
            <button
              type="button"
              className="relative ml-0.5 whitespace-nowrap rounded-md border border-transparent px-6 py-2 text-sm font-medium text-gray-200 hover:bg-gray-800 focus:z-10 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-700"
            >
              Yearly billing
            </button>
          </div>
        ...
        <div className="relative mx-auto mt-8 max-w-2xl px-4 pb-8 sm:mt-12 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-0">
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 bottom-6 left-8 right-8 top-4 hidden rounded-tl-lg rounded-tr-lg bg-gray-700 lg:block"
          />
            ...
            {plans.map((plan) => (
              <div
                ...
                className={classNames(
                  plan.featured
                    ? "bg-white shadow-md ring-2 ring-gray-700"
                ...
                <ul
                  ...
                  className={classNames(
                    plan.featured
                      ...
                      : "divide-gray-500 divide-opacity-75 border-gray-500",
            ...
            <div key="plan.title" className="border-t border-gray-200">
              ...
              <div className="relative mt-6">
                ...
                <div
                  className={classNames(
                    plan.featured
                      ? "shadow-md ring-2 ring-gray-600"
        ...
        <div className="mx-auto max-w-7xl px-8 py-24">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="w-1/4 px-4">
                <div className="h-full w-full rounded-lg ring-2 ring-gray-600 ring-opacity-100" />
              </div>
              <div className="w-1/4 pl-4">
                <div className="h-full w-full rounded-lg ring-1 ring-black ring-opacity-5" />
              </div>
